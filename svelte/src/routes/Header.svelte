  ...
  <AppBar>
    {#snippet lead()}
        ...
        <SegmentedControl bind:group={valueSingle}>
          ...
          <Segment.Item bind:group={valueSingle} name="justify" value={"/radio"} on:change={() => goto("/radio")}
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Segment.Item bind:group={valueSingle} name="justify" value={"/mcdu"} on:change={() => goto("/mcdu")}
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Segment.Item bind:group={valueSingle} name="justify" value={"/weather"} on:change={() => goto("/weather")}
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Segment.Item bind:group={valueSingle} name="justify" value={"/flightplan"} on:change={() => goto("/flightplan")}
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Segment.Item bind:group={valueSingle} name="justify" value={"/checklist"} on:change={() => goto("/checklist")}
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
    ...
    {#snippet trail()}
        ...
        <button type="button" class="btn-icon preset-filled" onclick={() => modalStore.trigger(settingsModal)} aria-label="Open Settings">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
